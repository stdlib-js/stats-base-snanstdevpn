...
```javascript
snanstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanstdevpn@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-snanstdevpn/tags). For example,

```javascript
snanstdevpn = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanstdevpn@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var snanstdevpn = require( 'path/to/vendor/umd/stats-base-snanstdevpn/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-snanstdevpn@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-snanstdevpn/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-snanstdevpn/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-base-snanstdevpn.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-base-snanstdevpn/main
...
[deno-readme]: https://github.com/stdlib-js/stats-base-snanstdevpn/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-snanstdevpn/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-snanstdevpn/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-snanstdevpn/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-snanstdevpn/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-snanstdevpn/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-base-snanstdevpn/main/LICENSE
